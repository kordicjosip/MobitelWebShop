  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>WebShop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               WebShop Head Office
               Email:support@webshop.com <br>
               Mob: +387 63 231 418 <br>
               Ljubuški 1207,FBIH <br>
  ...
  <table width="100%">
    ...
    <tbody>
     ...
     @foreach($orderItem as $item)
      <tr class="font">
        <td align="center">
            <img src="{{public_path($item->product->product_thambnail)}}" style="height: 60px; width:60px;" alt="">
        </td>
